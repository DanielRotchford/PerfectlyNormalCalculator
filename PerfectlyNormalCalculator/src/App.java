...
public class App extends JFrame {
	...
	public void Calculate() {
		...
		if (textdisplay.getText().equals("3.141") || textdisplay.getText().equals("3.141592")
				|| textdisplay.getText().equals("3.1415") || textdisplay.getText().equals("3.14159")) {
			textdisplay.setText("mega pie craving");
		} else if (textdisplay.getText().equals("3.14")) {
			textdisplay.setText("Today is Pi day!");
			customDisplay = true;
		} else if (textdisplay.getText().equals("42.0")) {
			textdisplay.setText("Life, the Universe, and Everything");
			customDisplay = true;
		} else if (textdisplay.getText().equals("00")) {
			textdisplay.setText("License to Kill");
